...
class loadData:
    ...
    def plot(self, tau_q):
        ...
        title = self.name+', '+r'$V=64\times 64$'
...
path = f"output/cooling/v64x64/4p0-0p0"
dest = f"output/plot/v64x64/4p0-4p0"
dt = loadData("Multi", "Cluster", 4, 0, path, dest)
dt.plot()

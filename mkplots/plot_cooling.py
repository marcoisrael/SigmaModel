...
params = {
    "charge": {"index": 2, "ylabel": r"$\chi_t$", "ylabel2": r"$\log(\chi_{tf})$", "func": f1},
    "energy": {"index": 4, "ylabel": r"$h$", "ylabel2": r"$\log(\mathcal{H}_f/V)$", "func": f1},
    "magnet": {"index": 6, "ylabel": r"$m$", "ylabel2": r"$\log(m_f)$", "func": f3},
}
...
for alg in algs:
    ...
    ax2.set_xlabel(r"$\log(\tau_Q)$", fontsize=20)
    ax2.set_yscale("log")
    ax2.set_xscale("log")
